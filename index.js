...
const tstream = express();
tstream.use(express.json());
tstream.use(cors());
tstream.use(bodyParser.json());

tstream.post("/stream", async (req, res) => {
    // const { stream } = await import("./stream.mjs");
